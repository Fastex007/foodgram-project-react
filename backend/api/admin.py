...
from .models import (Favorite, Ingredient, NecessaryIngredient, Recipe,
                     ShoppingCart, Tag)
...
class NecessaryIngredientAdmin(admin.ModelAdmin):
...
admin.site.register(NecessaryIngredient, NecessaryIngredientAdmin)
